...
@NonNullApi
public class CypherbyteProjectDependency extends DelegatingProjectDependency {

    @Inject
    public CypherbyteProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
